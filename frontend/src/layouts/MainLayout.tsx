    ...
    return (
        <div className="min-h-screen bg-slate-900 flex overflow-hidden relative">
            ...
            <main className="flex-1 relative z-10 flex flex-col w-full min-w-0">
                {/* Top Navigation Bar */}
                <header className="h-16 glass border-b border-slate-700/50 flex items-center justify-between px-4 sm:px-6 sticky top-0 z-30 gap-4">
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        <h2 className="text-lg font-bold text-white truncate">{getCurrentPageTitle()}</h2>
                    </div>
                    ...
                    <div className="relative flex items-center gap-2 shrink-0">
                        ...
                        <button
                            ...
                            className="p-2 text-slate-400 hover:text-white rounded-xl hover:bg-slate-800/60 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                            title="Toggle Theme"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center gap-2.5 p-1.5 pr-3 rounded-xl hover:bg-slate-800/60 transition-colors border border-transparent hover:border-slate-700/50"
                        >
                            <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-500 to-purple-500 flex items-center justify-center uppercase font-bold text-white text-sm shadow-md shrink-0">
                            ...
                            <ChevronDown className={clsx("w-4 h-4 text-slate-400 transition-transform duration-200", dropdownOpen ? "rotate-180" : "")} />
                        </button>
                        ...
                        {dropdownOpen && (
                            <>
                                ...
                                <div className="absolute right-0 top-full mt-2 w-56 glass-card border border-slate-600/50 shadow-2xl shadow-slate-900/50 z-50 overflow-hidden">
                                    ...
                                    {/* Desktop user info */}
                                    <div className="p-3 border-b border-slate-700/50 hidden sm:block">
                                        <p className="text-sm font-semibold text-white truncate">{user?.name}</p>
                                        <p className="text-xs text-slate-400 truncate">{user?.email}</p>
                                        <span className="inline-flex items-center mt-1.5 px-2 py-0.5 text-[10px] font-medium rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20">
                                            {user?.role}
                                        </span>
                                    </div>
                                    <div className="p-1.5">
